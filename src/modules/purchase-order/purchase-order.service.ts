...
import { PrismaTransactionClient, PurchaseSequenceNumber } from 'src/common/types/common.types';
import { automaticJournalWithLinesArgs } from 'src/common/types/journal-entry.types';
import {
...
import { CrossSiteSalesOrder, UpdatedPurchaseOrderLinkedWithSalesOrder } from 'src/common/types/sales-order.types';
          ...
          linesToUpdate.push({
            where: {
              orderNumber_lineNumber_sequenceNumber: {
                ...
                sequenceNumber: salesLine.lineNumber,
              },
            },
            data: {
              ...
              interCompanySalesOrderSequenceNumber: salesLine.lineNumber,
              salesOrder: salesOrder.orderNumber,
              salesOrderLine: salesLine.lineNumber,
              salesOrderSequenceNumber: salesLine.lineNumber,
            },
          });
        }
      }
