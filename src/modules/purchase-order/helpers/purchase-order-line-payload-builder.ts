...
import { AutomaticJournalLine, AutomaticJournalWithLines } from 'src/common/types/journal-entry.types';
import { generateUUIDBuffer, getAuditTimestamps } from 'src/common/utils/audit-date.utils';
import { formatNumberWithLeadingZeros } from 'src/common/utils/common.utils';
import { LocalMenus } from 'src/common/utils/enums/local-menu';
import { CalculatedPrice } from 'src/common/utils/sales-price.utils';
