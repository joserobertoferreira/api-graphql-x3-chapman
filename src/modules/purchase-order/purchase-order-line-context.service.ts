...
import { PurchaseOrderLineContext } from 'src/common/types/purchase-order.types';
import { countNonEmptyProperties } from 'src/common/utils/common.utils';
import { LocalMenus } from 'src/common/utils/enums/local-menu';
import { Company, Dimensions } from 'src/generated/prisma/client';
 ...
 * This function checks each line of a purchase order to ensure that:
 */
export async function validateLines(
...
): Promise<PurchaseOrderLineContext[]> {
  ...
  const contextLines: PurchaseOrderLineContext[] = [];
