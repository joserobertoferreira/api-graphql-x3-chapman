...
import { IntercompanyJournalEntryLineInput } from '../../modules/financials/intercompany-journal-entry/dto/create-intercompany-journal-entry-line.input';
import { CreateIntercompanyJournalEntryInput } from '../../modules/financials/intercompany-journal-entry/dto/create-intercompany-journal-entry.input';
import { JournalEntryLineInput } from '../../modules/financials/journal-entry/dto/create-journal-entry-line.input';
import { CreateJournalEntryInput } from '../../modules/financials/journal-entry/dto/create-journal-entry.input';
 ...
 */
export interface IntercompanyJournalEntryLineContext extends Omit<
  IntercompanyJournalEntryLineInput,
  'dimensions' | 'businessPartner'
> {
  lineNumber: number;
  ledgerType: LocalMenus.LedgerType;
  ledger: string;
...
export const automaticJournalWithLinesArgs = (options?: { lineFilter?: Prisma.AutomaticJournalLinesWhereInput }) => {
  ...
  } satisfies Prisma.AutomaticJournalFindManyArgs;
};
