...
/**
 * Generates a UUID v4 and returns it as a 16-byte Uint8Array,
 ...
 */
export function generateUUIDBuffer(): Uint8Array {
  // Generate a standard UUID as a string (e.g., 'f8a4a5b0-3b9c-4e4a-9e1e-2b0a1b9b0a1b')
  const uuidString = uuidv4();

  // Convert the UUID string to its byte representation (an array of 16 numbers)
